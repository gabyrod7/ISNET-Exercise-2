...
#In these type of files (that end with the word "Model") we specify all the details needed for a model to be used by the program. In this file we are giving the details for a third degree polynomial (cubic) of the form: F(q) = a3*q^3 + a2*q^2 + a1*q + a0
...
##Par is = [a0,a1,a2,a3]
def F(q,Fpar):
    return Fpar[0]+q*Fpar[1]+Fpar[2]*q**2+Fpar[3]*q**3
...
def FNoList(q,a0,a1,a2,a3):
    return F(q,[a0,a1,a2,a3])
